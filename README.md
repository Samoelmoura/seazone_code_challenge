...
3. The last real reservation date will be considered the last date on which the feature available is equal to true. Since there are future samples until December 2023
